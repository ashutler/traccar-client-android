...
public class MainApplication extends MultiDexApplication {
    ...
    private static final String DEFAULT_USERNAME = "dustin@cydonian.ca";
    private static final String DEFAULT_PASSWORD = "caixI8tLJk4x";

    private static final String DEFAULT_SERVER = "http://cydonian.homelinux.net:8082"; // local - http://10.0.2.2:8082
    ...
    private void initService() {
        ...
        String email = preferences.getString(PREFERENCE_EMAIL, DEFAULT_USERNAME);
        final String password = preferences.getString(PREFERENCE_PASSWORD, DEFAULT_PASSWORD);
